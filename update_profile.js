...
content = content.replace(/glass/g, 'bg-white/90 backdrop-blur-md shadow-sm');
content = content.replace(/text-marine-950/g, 'text-white');
content = content.replace(/bg-white text-slate-900 shadow-xl/g, 'bg-slate-900 text-white shadow-xl');
content = content.replace(/text-slate-900\/40/g, 'text-slate-400'); // Clean up any weird leftovers
